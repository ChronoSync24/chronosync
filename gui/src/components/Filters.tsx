...
const Filters: React.FC<FiltersProps> = ({
    ...
    const sortedFields = React.useMemo(() => {
        const typeOrder = { text: 1, number: 2, select: 3, multiselect: 4, date: 5 };
                                        ...
                                        {visibleItems.map((val) => {
                                            ...
                                            return (
                                                <Chip
                                                    ...
                                                    onDelete={() => {
                                                        const newValue = selectedArray.filter(s => s !== val);
                                    ...
                                    {Object.entries(values).map(([key, value]) => {
                                        ...
                                        return (
                                            <Chip
                                                ...
                                                size="small"
                                                onDelete={() => onFilterChange(key, Array.isArray(value) ? [] : '')}
                                                color="secondary"
                                                variant="outlined"
                                            />
                                        );
